    ...
    inputSchema: {
      ...
      properties: {
        reason: {
          type: 'string',
          description:
            'Short, human-readable note on what is still running and what you will report back (e.g. "rebuilding + restarting pikiclaw, will confirm after it comes back up").',
        },
      },
      required: ['reason'],
    },
